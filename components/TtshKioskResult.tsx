...
export default function ({
	...
	message =
		mode === "ttsh_kiosk"
			? "Temperature check and face mask check success. Please proceed with the registration at the kiosk."
			: "Temperature check and face mask check success. Please scan your ID.";
	message2 = "请前往主要信息亭";
