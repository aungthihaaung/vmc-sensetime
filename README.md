...
```
http://localhost:8787/scan?visitor_id=ST_000006&temp=36.8&device_id=123
```

## staff not found

```
http://localhost:8787/scan?visitor_id=ST_000006_wrong&temp=36.8&device_id=123
```

## stranger

```
http://localhost:8787/scan?visitor_id=null&temp=36.8&device_id=123
```
